defmodule XMAVLink.Test.Utils do
  ...
  test "x25 simple list" do
    # Checked against mavcrc.x25crc.accumulate()
    assert x25_crc([1, 2, 3]) == 25284
  end

  test "x25 simple binary" do
    # Checked against mavcrc.x25crc.accumulate_str()
    assert x25_crc("123") == 25419
  end
  ...
  test "x25 heartbeat seed" do
    assert x25_crc("HEARTBEAT ")
           ...
           # Checked against mavgen
           |> eight_bit_checksum() == 50
  end
