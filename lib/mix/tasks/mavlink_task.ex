defmodule Mix.Tasks.Xmavlink do # Xmavlink case required for `mix xmavlink ...` to work
  ...
  @spec get_message_code_fragments([XMAVLink.Parser.message_description], [enum_detail], String.t) :: [ String.t ]
  ...
  @spec calculate_message_crc_extra(XMAVLink.Parser.message_description) :: XMAVLink.Types.crc_extra
